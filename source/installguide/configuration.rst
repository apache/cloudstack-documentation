...
.. note::
      ...
      Administrator can also register SYSTEM and ROUTING template with the same name for different architectures to allow deployment across them depending on the compute capacity.
